    ...
    public partial class BatchStatus : IEquatable<BatchStatus>
    {
        ...
        public bool Equals(BatchStatus other)
        {
            ...
            return 
                ...
                (
                    JobStatuses == other.JobStatuses ||
                    JobStatuses != null &&
                    other.JobStatuses != null &&
                    JobStatuses.SequenceEqual(other.JobStatuses)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (BatchType != null)
                    hashCode = hashCode * 59 + BatchType.GetHashCode();
                    if (Created != null)
                    ...
                    if (JobStatuses != null)
                    hashCode = hashCode * 59 + JobStatuses.GetHashCode();
                    if (Message != null)
